...
type AdminKnowledge = { id?:number; title:string; tags:string; content:string; enabled:boolean; updatedAt?:string }
...
const emptyKnowledge=():AdminKnowledge=>({title:'',tags:'',content:'',enabled:true})
