...
<main :class="['site',{dark}]">
  ...
  <section v-else-if="route.name==='share'" class="share-page">
    ...
    <p class="share-note">{{text('以上为邀请链接。点击后会离开本站；具体服务内容与规则请以对应网站为准。','These are referral links. You will leave this site; please check each provider for its current service details and terms.')}}</p>
  </section>
...
.share-card:nth-child(2) { background: #f8e5dc; }
