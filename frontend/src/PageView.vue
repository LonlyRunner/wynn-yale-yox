...
type AiJob = { id:number; provider:string; type:string; prompt:string; status:string; resultUrl:string; downloadUrl?:string; error:string; resolution?:string; duration?:number; createdAt?:string; inGallery?:boolean }
