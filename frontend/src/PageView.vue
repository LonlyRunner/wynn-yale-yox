...
const pelicanModels=['本地 SVG','Qwen 3.8 Max'] as const
const pelicanModel=ref<(typeof pelicanModels)[number]>('本地 SVG'),pelicanJumping=ref(false)
const pelicanArtUrl=computed(()=>pelicanModel.value==='Qwen 3.8 Max'?'/media/game-art/pelican-qwen.svg':'')
    ...
    <div class="game-shell">
      <div v-if="gameId==='pelican'" class="pelican-panel">
        ...
        <div :class="['pelican-ride',{'is-playing':playing,'is-jumping':pelicanJumping,'model-generated':!!pelicanArtUrl}]" @click="jumpPelican">
          <img v-if="pelicanArtUrl" class="model-generated-art" :src="pelicanArtUrl" :alt="text(`${pelicanModel} 生成的鹈鹕骑行插画`,`${pelicanModel} generated pelican cycling artwork`)">
