...
<main :class="['site',{dark}]">
  <header v-if="route.name!=='admin'" class="topbar">
    ...
    <nav :class="{open:mobileOpen}">
      ...
      <RouterLink to="/share"><span class="share-nav-charm" aria-hidden="true">✦</span>{{text('分享','Links')}}</RouterLink>
...
.share-nav-charm { display: grid; width: 23px; height: 23px; flex: 0 0 auto; place-items: center; color: #b97868; font-size: 23px; line-height: 1; }
...
.share-intro>span { position: absolute; right: 5%; top: -35px; color: #e7b6a6; font: 150px/1 var(--serif); opacity: .55; }
...
.share-card-meta span { display: grid; width: 52px; height: 52px; place-items: center; border-radius: 18px; color: #fffaf5; background: #bd806f; font-size: 29px; }
